...
import { SupabaseUserSession } from "../../CodeComponents/DatabaseComponents"; // plasmic-import: QeHZ21KIO6/codeComponent
import { SupabaseTextField } from "../../CodeComponents/DisplayCollections"; // plasmic-import: f6hHmfgMEx/codeComponent
import { SupabaseUserLogOut } from "../../CodeComponents/DatabaseComponents"; // plasmic-import: _RPWXvo1ur/codeComponent
...
import sty from "./PlasmicNavBar.module.css"; // plasmic-import: 0q7MR0_Uzm/css
...
function PlasmicNavBar__RenderFunc(props: {
  ...
  return (
    ...
    >
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__aOu57)}>
          <div
            className={classNames(
              projectcss.all,
      ...
      <div className={classNames(projectcss.all, sty.freeBox___46QuA)}>
        {true ? (
          <div className={classNames(projectcss.all, sty.freeBox__f1Ce5)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
