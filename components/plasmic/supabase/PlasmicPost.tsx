...
import sty from "./PlasmicPost.module.css"; // plasmic-import: pm7cbWoDyv/css
    ...
    >
      {true ? (
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__h3Mgt)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__r2U4I)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames(
          ...
          {true ? (
            <div className={classNames(projectcss.all, sty.freeBox___040Qv)}>
              {p.renderPlasmicSlot({
                defaultContents: (
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__fTieI)}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__dVOcq)}>
            {p.renderPlasmicSlot({
      ...
      {true ? (
        <div className={classNames(projectcss.all, sty.freeBox__kQuH9)}>
          {true ? (
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__opnUd)}
            >
              <SupabaseEditButton
              ...
              >
                <EditIcon
                  className={classNames(projectcss.all, sty.svg__beYyE)}
                  role={"img"}
                />
              </SupabaseEditButton>
              ...
              >
                <DeleteIcon
                  className={classNames(projectcss.all, sty.svg__uOnNl)}
                  role={"img"}
                />
              </SupabaseDeleteButton>
            </p.Stack>
