...
import { SupabaseEditButton } from "../../CodeComponents/UtilsComponents"; // plasmic-import: ExYk9hOSJJ/codeComponent
...
import sty from "./PlasmicMountain.module.css"; // plasmic-import: 0_x3kRL41N/css
          ...
          >
            <SupabaseGridCollection
              ...
              loading={
                <React.Fragment>
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__qRaNe)}
                  ...
                  <p.PlasmicImg
                    ...
                    loading={"lazy" as const}
                    src={{
                      src: "/plasmic/supabase/images/loading.gif",
                      fullWidth: 300,
                      fullHeight: 300,
                      aspectRatio: undefined
                    }}
            ...
            >
              ...
              >
                ...
                >
                  <EditIcon
                    className={classNames(projectcss.all, sty.svg__iRtYg)}
                    role={"img"}
                  />
                </SupabaseEditButton>
                ...
                <SupabaseDeleteButton
                  className={classNames(
                    "__wab_instance",
                    sty.supabaseDeleteButton__b6Szd
                  )}
                  id={"{{row.id}}" as const}
                  modal={
                    <SupabaseMutation
                ...
                >
                  <DeleteIcon
                    className={classNames(projectcss.all, sty.svg__fV8C)}
                    role={"img"}
                  />
                </SupabaseDeleteButton>
              </div>
            ...
            <SupabaseTableCollection
              ...
              deleteSlot={
                <SupabaseDeleteButton
                  className={classNames(
                    "__wab_instance",
                    sty.supabaseDeleteButton__jTwE
                  )}
                  id={"{{row.id}}" as const}
                  modal={
                    <SupabaseMutation
                ...
                >
                  <DeleteIcon
                    className={classNames(projectcss.all, sty.svg__nkJaP)}
                    role={"img"}
                  />
                </SupabaseDeleteButton>
              }
              editSlot={
                <EditIcon
                  className={classNames(projectcss.all, sty.svg__x4OBr)}
                  role={"img"}
                />
              }
              loading={"Loading..."}
